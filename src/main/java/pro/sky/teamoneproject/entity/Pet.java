...
public class Pet {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, gender, age, species, rulesForGettingToKnowAnimals, listofDocuments, listOfRecommendationForMovePet, informationAboutTheLivingConditionPet, consultationDoghandlerForFirstCommunication, contactWitsOtherDoghanlers, reasonWhyShelterCanReject);
    }
//    @Override
//    public boolean equals(Object o) {
//        if (this == o) return true;
